...
public final class FatefulSort implements SortAlgorithmInterface {
  public FatefulSort() {
    ...
    //https://xkcd.com/1185/ and will only work on data sets that by fate are
    //already sorted. Becuase it relies so much on fate it does not include any
    //error checking (if you can't trust fate then what good is error checking)
  }
